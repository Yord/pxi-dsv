...
module.exports = {
  name: 'ssv',
  desc: (
    'is a space-separated values serializer. It is a variant of dsv, but differs in its default values: ' +
    ...
    'To turn it off, ssv supports the following additional options:\n\n' +
